$(function () {
  ...
  function setup() {
    ...
    createCollectable("database", 750, 300); // creates a "database" collectible at the coordinates (500, 300), falling with default gravity and bouncing with default bounce %
    createCollectable("grace", 650, 300); // creates a "grace" collectible at the coordinates (500, 300), falling with default gravity and bouncing with default bounce %
    ...
    createCannon("top", 350, 1200); // cannon on left wall, 600px down, shooting once per second
    createCannon("top", 800, 1600); // cannon on left wall, 600px down, shooting once per second
